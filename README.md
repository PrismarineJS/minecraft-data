...
| Data renames | (for PC 1.8+) mappings between old and new block and item names e.g. `tallgrass` -> `grass`, `grass` -> `short_grass` (from oldest to newest) or `yellow_wool` -> `wool` (from 1.13+ to 1.12-)

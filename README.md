...
| [blocks](enums/blocks.json) | [blocks_extractor](tools/js/wiki_extractor/blocks_extractor.js) | minecraft wiki |
...
| [recipes](enums/recipes.json) | [recipes_extractor](tools/js/wiki_extractor/recipes_extractor.js) | minecraft wiki |
...
| [protocol](enums/protocol.json) | | manual but [protocol_extractor](tools/js/wiki_extrator/protocol_extractor.js) and [protocol_extractor](tools/js/decompiled_extractor/protocol_extractor.json) can be useful for updating it |

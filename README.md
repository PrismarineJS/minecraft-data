...
| [protocol](enums/protocol.json) | | manual but [bin/wiki_extrator/protocol_extractor.js][protocol_extractor] and [protocol_extractor](bin/decompiled_extractor/protocol_extractor.json) can be useful for updating it |

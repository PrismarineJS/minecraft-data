...
| --------- | --------- | ------ |
| [items](enums/items.json) | [item_extractor](https://github.com/PrismarineJS/minecraft-wiki-extractor/blob/master/bin/item_to_json.js) | minecraft wiki |
| [entities](enums/entities.json) | [entities_extractor](https://github.com/PrismarineJS/minecraft-wiki-extractor/blob/master/bin/entities_to_json.js) | minecraft wiki |
| [blocks](enums/blocks.json) | [block_extractor](https://github.com/PrismarineJS/minecraft-wiki-extractor/blob/master/bin/block_to_json.js) | minecraft wiki |
...
| [recipes](enums/recipes.json) | [recipe_extractor](https://github.com/PrismarineJS/minecraft-wiki-extractor/blob/master/bin/recipe_to_json.js) | minecraft wiki |
...
| [protocol](enums/protocol.json) | | manual but [protocol_extractor](https://github.com/PrismarineJS/mcdevs-wiki-extractor) and [protocol_extractor](tools/js/decompiled_extractor/protocol_extractor.json) can be useful for updating it |

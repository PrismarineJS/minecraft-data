## 3.117.0
* [bedrock: add 1.26.51 (protocol 2193) (#1321)](https://github.com/PrismarineJS/minecraft-data/commit/ab159df5d5ccc736024f18589ea55ea6c33fe218) (thanks @Pix3lPirat3)
* [Regenerate pc 1.10, 1.11 and 1.12 recipes from the game (#1283)](https://github.com/PrismarineJS/minecraft-data/commit/f59168c3ce23158527ea7c3743ac16f18f96cf25) (thanks @u9g)
* [pc/26.1: map every InteractionHand field to main_hand/off_hand (#1278)](https://github.com/PrismarineJS/minecraft-data/commit/1131ad94628ea2bdf7d475b4c98de02eed67d7e3) (thanks @u9g)
* [pc: Fix 1.21.5+ materials.json shears speed (#1310)](https://github.com/PrismarineJS/minecraft-data/commit/08a8e3a5f69d82471045cd2bd325638f6795b515) (thanks @Pix3lPirat3)
* [pc/protocol: set_cursor_item and set_player_inventory carry a plain Slot on 1.21.3 (#1303)](https://github.com/PrismarineJS/minecraft-data/commit/20a0b0142d99d9a069aa8fec98512ec082b4f0a3) (thanks @u9g)
* [Fix PC protocol enum inconsistencies in difficulty, game-state reasons, and entity actions packet fields (#1295)](https://github.com/PrismarineJS/minecraft-data/commit/886d159e4dc349d6b9204df2d17e1ea29e7b546e) (thanks @Copilot)
* [Align Bedrock 1.21.x block ranges with runtime state palettes (#1276)](https://github.com/PrismarineJS/minecraft-data/commit/3796c6d1e471d470788c7a60b314e214d252d1f8) (thanks @Pix3lPirat3)
* [Add 26.3 to pc protocolVersions.json](https://github.com/PrismarineJS/minecraft-data/commit/81612cde17674eeaf4c716b660c317168e9bd910) (thanks @github-actions[bot])
* [Add 26.3-rc-3 to pc protocolVersions.json](https://github.com/PrismarineJS/minecraft-data/commit/028a08a5683e45cd02db1d3edb223e925b67400c) (thanks @github-actions[bot])
* [Add the useEntityHasLocation feature (#1282)](https://github.com/PrismarineJS/minecraft-data/commit/b443bbc1db5122c8a8da379d59f8819f35e1bfa8) (thanks @u9g)
* [pc/protocol: entity_teleport layout for 1.21.2+ (velocity, f32 rotation, relative flags) (#1273)](https://github.com/PrismarineJS/minecraft-data/commit/0087fbf453c85a77f333d0709ca96aa50172b092) (thanks @u9g)
* [pc: fix intangible_projectile NBT and 26.1 item stack templates (#1267)](https://github.com/PrismarineJS/minecraft-data/commit/fb64396498125758e0490f8e6e4f232e16490868) (thanks @u9g)
* [Add 26.3-rc-2 to pc protocolVersions.json](https://github.com/PrismarineJS/minecraft-data/commit/0c9f59011af7082e51b5fec97abe5a36f9e12ee6) (thanks @github-actions[bot])
* [Add protocol mapper switch sanity test and correct existing `switch` errors (#1286)](https://github.com/PrismarineJS/minecraft-data/commit/57fa53e2b4bf4b1ef491166ebf7eb8b338cb7425) (thanks @Copilot)
* [Add 26.3-rc-1 to pc protocolVersions.json](https://github.com/PrismarineJS/minecraft-data/commit/9025cb4e1e1256e5808e93edc628a3094a271dc1) (thanks @github-actions[bot])
* [Add 26.3-pre-3 to pc protocolVersions.json](https://github.com/PrismarineJS/minecraft-data/commit/8c6525b6cc0df0e218d01824d724017222e9b05e) (thanks @github-actions[bot])
* [features: sneakUsesEntityAction for 1.8 through 1.21.5 (#1275)](https://github.com/PrismarineJS/minecraft-data/commit/3d75720098b35bdacaa9a6ba56bb9f53e93a9a66) (thanks @u9g)
* [pc/protocol: cookie_response value is optional on 1.21.8 (#1274)](https://github.com/PrismarineJS/minecraft-data/commit/54e1bed00ab3f1d98f603935ddfe2570329a31d1) (thanks @u9g)
* [Fix pc/1.21.11 attribute_modifiers entry shape (#1253)](https://github.com/PrismarineJS/minecraft-data/commit/f5f3aaf7fbc60279b28ab3f3e35fcfb3096d6f36) (thanks @Copilot)
* [pc/protocol: fix particle packets on 1.21.3+ (#1179)](https://github.com/PrismarineJS/minecraft-data/commit/fc2b5b89012138deaf777aa0cc68474455b8c323) (thanks @MayorLeon20)
